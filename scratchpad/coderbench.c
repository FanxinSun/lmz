...
int main(int argc, char **argv)
{
    ...
    printf("\nThe last rows, in order.\n\n"
           ...
           "  chunks win a little while 16 states loses harder -- so the register\n"
           "  file and the length of the cursor chain are both doing something.\n\n"
           "  Measured: chunks reach 1.03x to 1.13x on Apple silicon and stop\n"
           "  there, flat through three and four. That is the ceiling on getting\n"
           "  at the headroom below with general-purpose registers, and it is not\n"
           "  worth pairing chunks through a decode pipeline to collect. What is\n"
           "  left is a register file big enough to hold more states: the vector\n"
           "  one, eight lanes per chunk and a register per chunk.\n\n"
